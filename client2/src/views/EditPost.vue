            ...
            <v-col sm="10" class="mx-auto">
                <v-card class="pa-5">
                    ...
                    <v-form ref="form" @submit.prevent="updateForm" class="pa-5" enctype="multipart/form-data">
                        ...
                        <v-img :src="`/${post.image}`" width="350"></v-img>

                        <v-btn type="submit" class="mt-3" color="success">UPADTE POST</v-btn>&nbsp;

                        <v-btn type="cancel" class="mt-3" color="error" :to="{ name: 'post', params: {id: post._id}}">CANCEL</v-btn>
                    </v-form>
                </v-card>
            </v-col>
        </v-row>
        ...
        methods:{
            ...
            async updateForm(){
                ...
                if(this.$refs.form.validate()){
                    ...
                    this.$router.push({name: 'home', parmas: {message: response.message}});
                }
            }
        }
    };
